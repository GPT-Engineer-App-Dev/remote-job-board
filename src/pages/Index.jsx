  ...
  return (
    <Container centerContent maxW="container.md" py={10}>
      <VStack spacing={4} width="100%">
        ...
        <HStack spacing={4}>
          <Button onClick={() => setSelectedCategory("")} colorScheme={selectedCategory === "" ? "blue" : "gray"}>All</Button>
          <Button onClick={() => setSelectedCategory("Product")} colorScheme={selectedCategory === "Product" ? "blue" : "gray"}>Product</Button>
          <Button onClick={() => setSelectedCategory("Design")} colorScheme={selectedCategory === "Design" ? "blue" : "gray"}>Design</Button>
          <Button onClick={() => setSelectedCategory("Engineering")} colorScheme={selectedCategory === "Engineering" ? "blue" : "gray"}>Engineering</Button>
        </HStack>
        <VStack spacing={4} width="100%" pt={6}>
