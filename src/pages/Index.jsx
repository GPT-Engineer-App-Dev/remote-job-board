...
const jobs = [
  ...
  { id: 6, title: "Technical Product Manager", category: "Product" },
];
  ...
  return (
    <Container maxW="container.lg" py={10}>
      <VStack spacing={6} align="stretch">
        ...
        <Text fontSize="lg" textAlign="center">Find your next remote job in tech. Filter by category to narrow down your search.</Text>
